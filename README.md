...
- 可选账号轮换发布，并自定义每个账号连续成功发布几条后切换；各账号按自己的剩余配额精确收尾。
...
- 音乐已生效时直接跳过；未生效时只重开并重试音乐步骤，兼容不显示使用量或时长的新版音乐列表。
...
- `release/DouyinPublisher_Setup_v3.0.3.exe`
- `packages/DouyinPublisher_Update_v3.0.3.zip`
