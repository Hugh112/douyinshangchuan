...
- 所有账号共享一个图片总文件夹；新表格可用“城市、标题、文案”三列表头，按城市匹配同名图片子文件夹，标题为空时保持旧发布方式。
...
- `release/DouyinPublisher_Setup_v3.0.1.exe`
- `packages/DouyinPublisher_Update_v3.0.1.zip`
